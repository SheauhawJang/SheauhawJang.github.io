...
function processInput() {
    ...
    worker = new Worker("mahjong-worker.js?v=202608091152");
    let task = 0;
...
function restartInput(i) {
    ...
    reworkers[i] = new Worker("mahjong-worker.js?v=202608091152");
...
function processGBScore() {
    ...
    gb_worker = new Worker("mahjong-worker.js?v=202608091152");
...
function processJPScore() {
    ...
    jp_worker = new Worker("mahjong-worker.js?v=202608091152");
...
function processSCScore() {
    ...
    sc_worker = new Worker("mahjong-worker.js?v=202608091152");
