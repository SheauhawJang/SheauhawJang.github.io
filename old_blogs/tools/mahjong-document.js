...
function processInput() {
    ...
    worker = new Worker("mahjong-worker.js?v=202609060214");
    let task = 0;
...
function restartInput(i) {
    ...
    reworkers[i] = new Worker("mahjong-worker.js?v=202609060214");
...
function processGBScore() {
    ...
    gb_worker = new Worker("mahjong-worker.js?v=202609060214");
...
function processJPScore() {
    ...
    jp_worker = new Worker("mahjong-worker.js?v=202609060214");
...
function processSCScore() {
    ...
    sc_worker = new Worker("mahjong-worker.js?v=202609060214");
