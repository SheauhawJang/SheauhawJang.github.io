...
function processJPSetting(id) {
    ...
    // prettier-ignore
    const rules = [
        [[1, 2, 3], [39, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 0, 6, 0, 0, "9,1", 10, undefined, 14, 15, ...localyaku0, 0]], // XJTU (0)
        [[3], [1, 2, 39, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 0, 6, 0, 0, "9,1", 10, undefined, 14, 15, ...localyaku0, 0]], // XJTU 7 Stars (1)
        [[2, 3, 39], [1, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 0, 0, "9,1", 0, undefined, 14, 15, ...localyaku0, 0]], // JPML (2)
        [[2, 3, 39], [1, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 7, 0, "9,1", 0, undefined, 14, 15, ...localyaku0, 0]], // JPML WRC (3)
        [[2], [1, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 7, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Saikouisen (4)
        [[2], [1, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 0, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Saikouisen Classic (5)
        [[2], [1, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 7, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // ClubJPM (6=4)
        [[2], [1, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 7, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // M.League (7=4)
        [[39], [1, 2, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 0, 6, 0, 0, "9,1", 0, undefined, 14, 15, ...localyaku0, 0]], // EMA (8)
        [[1, 2, 3, 13], [11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 0, 6, 0, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Mahjong Soul (9)
        [[1, 2, 3, 13, 26, 27, 28, 32, 33, 34, 35, 38], [11, 24, 25, 29, 30, 31, 36, 37, 41, 42, 43], [4, 0, 6, 0, 0, "9,2", 10, undefined, 14, 15, 0, 0, 0, 19, 0, "21,3", 0, "40,2", "44", 0]], // Mahjong Soul Local Yaku (10)
        [[2, 3], [1, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [undefined, 0, 6, 0, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Tenhou (11)
        [[], [1, 2, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 0, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Shinhouchi (12)
        [[], [1, 2, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 0, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // Mu (13=12)
        [[2], [1, 3, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 7, 0, 0, 0, undefined, 14, 15, ...localyaku0, 0]], // RMU (14=4)
        [[], [1, 2, 3, 39, 11, 24, 25, ...bigwheels, ...luckylocals, 41, 42, 43], [4, 5, 6, 0, 0, "9,3", 0, undefined, 14, 15, ...localyaku0, 0]], // Zendanshin (15)
    ];
