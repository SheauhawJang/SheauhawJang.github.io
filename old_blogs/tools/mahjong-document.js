...
function processInput() {
    ...
    worker = new Worker("mahjong-worker.js?v=202608082307");
    let task = 0;
...
function restartInput(i) {
    ...
    reworkers[i] = new Worker("mahjong-worker.js?v=202608082307");
...
function processGBScore() {
    ...
    gb_worker = new Worker("mahjong-worker.js?v=202608082307");
...
function processJPScore() {
    ...
    jp_worker = new Worker("mahjong-worker.js?v=202608082307");
...
function processSCScore() {
    ...
    sc_worker = new Worker("mahjong-worker.js?v=202608082307");
