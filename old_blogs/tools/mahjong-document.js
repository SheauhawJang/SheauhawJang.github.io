...
function processInput() {
    ...
    worker = new Worker("mahjong-worker.js?v=202608091234");
    let task = 0;
...
function restartInput(i) {
    ...
    reworkers[i] = new Worker("mahjong-worker.js?v=202608091234");
...
function processGBScore() {
    ...
    gb_worker = new Worker("mahjong-worker.js?v=202608091234");
...
function processJPScore() {
    ...
    jp_worker = new Worker("mahjong-worker.js?v=202608091234");
...
function processSCScore() {
    ...
    sc_worker = new Worker("mahjong-worker.js?v=202608091234");
