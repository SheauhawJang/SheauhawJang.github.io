...
function printWaiting(step, getWaiting, getSubchecks, fk) {
    if (full_tcnt !== tcnt) {
        ...
        if (gans !== undefined) {
            ...
            result += `<div>${loc.wait} ${cnt} ${loc.counts}</div><div class="devided-waiting-td"><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.goodshape} ${gcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.goodshape_short} ${gcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${gans.map(cardImage).join("")}</div></div><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.badshape} ${bcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.badshape_short} ${bcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${ans.map(cardImage).join("")}</div></div><div class="devided-waiting-brief">${loc.goodshaperate} ${ratio.toFixed(2)}%</div><div class="devided-waiting-brief-short">${loc.goodshaperate_short} ${ratio.toFixed(2)}%</div></div>`;
        } else {
        ...
        for (const { cnt, bcnt, gcnt, id } of cnts) {
            ...
            if (gcnt !== undefined) result += `<div>${verb} ${cardImage(rid)} ${loc.wait} ${cnt} ${loc.counts}</div><div class="devided-waiting-td"><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.goodshape} ${gcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.goodshape_short} ${gcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${rsave.gans.map(cardImage).join("")}</div></div><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.badshape} ${bcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.badshape_short} ${bcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${rsave.ans.map(cardImage).join("")}</div></div><div class="devided-waiting-brief">${loc.goodshaperate} ${((gcnt / cnt) * 100).toFixed(2)}%</div><div class="devided-waiting-brief-short">${loc.goodshaperate_short} ${((gcnt / cnt) * 100).toFixed(2)}%</div></div>`;
        ...
        for (const { cnt, bcnt, gcnt, id } of nxt_cnts) {
            ...
            if (gcnt !== undefined) nxt_result += `<div>${verb} ${cardImage(id)} ${loc.wait} ${cnt} ${loc.counts}</div><div class="devided-waiting-td"><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.goodshape} ${gcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.goodshape_short} ${gcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${nxt_save[id].gans.map(cardImage).join("")}</div></div><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.badshape} ${bcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.badshape_short} ${bcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${nxt_save[id].ans.map(cardImage).join("")}</div></div><div class="devided-waiting-brief">${loc.goodshaperate} ${((gcnt / cnt) * 100).toFixed(2)}%</div><div class="devided-waiting-brief-short">${loc.goodshaperate_short} ${((gcnt / cnt) * 100).toFixed(2)}%</div></div>`;
        ...
        for (const { cnt, bcnt, gcnt, id, step } of kang_cnts) {
            const verb = loc.kang;
            if (gcnt !== undefined) kang_result += `<div>${verb} ${cardImage(id)} ${getWaitingType(step)} ${loc.wait} ${cnt} ${loc.counts}</div><div class="devided-waiting-td"><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.goodshape} ${gcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.goodshape_short} ${gcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${kang_save[id].gans.map(cardImage).join("")}</div></div><div class="devided-waiting-container"><div class="devided-waiting-brief">${loc.badshape} ${bcnt} ${loc.counts}</div><div class="devided-waiting-brief-short">${loc.badshape_short} ${bcnt} ${loc.counts_short}</div><div class="devided-waiting-cards">${kang_save[id].ans.map(cardImage).join("")}</div></div><div class="devided-waiting-brief">${loc.goodshaperate} ${((gcnt / cnt) * 100).toFixed(2)}%</div><div class="devided-waiting-brief-short">${loc.goodshaperate_short} ${((gcnt / cnt) * 100).toFixed(2)}%</div></div>`;
