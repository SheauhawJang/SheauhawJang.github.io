...
\newcommand{\dllim}[1]{\lim\limits_{\begin{subarray}c #1 \end{subarray}}}
...
\newcommand{\radx}[1]{\operatorname{rad}_ #1 }
\newcommand{\sgn}{\operatorname{sgn}}
\newcommand{\ord}{\operatorname{ord}}
\newcommand{\Aut}{\operatorname{Aut}}
\newcommand{\punit}[1]{\operatorname{ #1 }}
\newcommand{\simeqq}{\cong}
\newcommand{\tdeg}{^\circ}
\newcommand{\roku}{\partial}
\newcommand{\setsub}{\backslash}
\newcommand{\midd}{\parellal}
...
\newcommand{\dydx}[2]{\frac{\dif  #1 }{\dif  #2 }}
\newcommand{\dxdy}[2]{\frac{\dif  #2 }{\dif  #1 }}
\newcommand{\ddx}[1]{\frac{\dif}{\dif  #1 }}
\newcommand{\ryrx}[2]{\frac{\roku  #1 }{\roku  #2 }}
\newcommand{\rxry}[2]{\frac{\roku  #2 }{\roku  #1 }}
\newcommand{\rrx}[1]{\frac{\roku}{\roku  #1 }}
$$
